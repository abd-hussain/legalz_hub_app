  ...
  tryToFillTheFields(BuildContext context) {
    if (box.get(TempFieldToRegistrtAttorneyConstant.saturdayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.saturday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.saturdayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.sundayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.sunday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.sundayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.mondayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.monday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.mondayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.tuesdayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.tuesday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.tuesdayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.wednesdayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.wednesday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.wednesdayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.thursdayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.thursday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.thursdayWH));
    }
    if (box.get(TempFieldToRegistrtAttorneyConstant.fridayWH) != null) {
      listOfWorkingHourNotifier.value
          .firstWhere((element) => element.dayName == AppLocalizations.of(context)!.friday)
          .list = prepareList(context, box.get(TempFieldToRegistrtAttorneyConstant.fridayWH));
    }
